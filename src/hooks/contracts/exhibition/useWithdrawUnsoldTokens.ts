...
interface UseWithdrawUnsoldTokensReturn {
  withdrawUnsoldTokens: (projectId: bigint) => Promise<WriteResult>;
...
export function useWithdrawUnsoldTokens(): UseWithdrawUnsoldTokensReturn {
  ...
  const withdrawUnsoldTokens = useCallback(
